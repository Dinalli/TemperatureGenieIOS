...
/// Apples class for Keychain Password Item
struct KeychainPasswordItem {
    // MARK: Types
    /// Key chain error types
    enum KeychainError: Error {
        /// returned when noPassword
        case noPassword
        /// returned when unexpected password data
        case unexpectedPasswordData
        /// returned when unexpected item data
        case unexpectedItemData
        /// returned when unhandled error with status
    ...
    /// Get password items for the service
