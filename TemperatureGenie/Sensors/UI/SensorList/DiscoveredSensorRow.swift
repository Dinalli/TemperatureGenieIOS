...
struct DiscoveredSensorRow: View {
    ...
    var body: some View {
        HStack{
            NavigationLink(value: authenticationHelper.isAlertModeOnly() ? sensor.inAlarmState ? Route.alertSensor(sensor): Route.manualSensor(sensor) : Route.liveSensor(sensor)) {
                VStack {
